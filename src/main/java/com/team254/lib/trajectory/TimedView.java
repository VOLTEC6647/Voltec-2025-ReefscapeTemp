...
public class TimedView<S extends State<S>> implements TrajectoryView<TimedState<S>> {
    protected final Trajectory254<TimedState<S>> trajectory_;
    protected final double start_t_;
    protected final double end_t_;

    public TimedView(Trajectory254<TimedState<S>> trajectory) {
    ...
    @Override
    public Trajectory254<TimedState<S>> trajectory() {
        return trajectory_;
    }
}
