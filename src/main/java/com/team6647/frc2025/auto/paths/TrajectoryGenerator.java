...
public class TrajectoryGenerator {
	...
	public class TrajectorySet {
		...
		private Trajectory254<TimedState<Pose2dWithMotion>> center6() {
			List<Pose2d254> waypoints = new ArrayList<>();
			List<Rotation2d> headings = new ArrayList<>();
			waypoints.add(new Pose2d254(FieldLayout.kCoralCenter.getTranslation().x()-FieldLayout.kCoralDistance,FieldLayout.kCoralCenter.getTranslation().x(),new Rotation2d()));
			headings.add(Rotation2d.fromDegrees(0.0));
			return generate(waypoints, headings, List.of(), false, 1.1, 1.0);
		}
