...
public class CoralPivot extends ServoMotorSubsystem {
	...
	public static final double kLevel1Angle = 70.0, kLevel2Angle = 100.0, kLevel3Angle = 100.0, kLevel4Angle = 84.0, kIntakingAngle = 155.0, kAlgaeing1 = 80.0, kAlgaeing2 = 130.0;
