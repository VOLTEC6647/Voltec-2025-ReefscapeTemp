...
public abstract class AutoModeBase {
	...
	protected List<Trajectory254<TimedState<Pose2dWithMotion>>> trajectories = new ArrayList<>();
	...
	protected Trajectory254<TimedState<Pose2dWithMotion>> logTrajectory(
			Trajectory254<TimedState<Pose2dWithMotion>> trajectory) {
		trajectories.add(trajectory);
		return trajectory;
	}

	public List<Trajectory254<TimedState<Pose2dWithMotion>>> getPaths() {
		return trajectories;
	}
}
